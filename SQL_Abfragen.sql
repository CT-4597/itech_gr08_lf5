...
-- Ausgabe alle Personenbezogenen Daten
SELECT KUNDE.*, BESTELLUNG.*, SAMMLUNG.SAMMLUNGSBEZEICHNUNG FROM KUNDE
...
(SELECT * FROM SAMMLUNG
                    ...
                    ON SAMMLUNG.SAMMLUNGSNR = sub.SAMMLUNGMITALLERGENNR
                    WHERE SAMMLUNGMITALLERGENNR IS NULL AND SAMMLUNGSTYPNR=$ID_TYP) subAll
...
(SELECT ZUTATKATEGORIE.ZUTATENNR FROM ZUTATKATEGORIE WHERE SAMMLUNGZUTAT.ZUTATENNR = ZUTATKATEGORIE.ZUTATENNR AND ZUTATKATEGORIE.KATEGORIENR = $ID_KATEGORIE) 
