<?php
  ...
  $query = "SELECT * FROM KUNDE WHERE KUNDENNR=:userid";
  $query = "SELECT * FROM BESTELLUNG JOIN BESTELLUNGZUTAT WHERE BESTELLUNG.KUNDENNR = :userid";
  $query = "SELECT * FROM BESTELLUNG JOIN BESTELLUNGSAMMLUNG WHERE BESTELLUNG.KUNDENNR = :userid";
  $query = "SELECT KUNDE.*, BESTELLUNG.*, SAMMLUNG.SAMMLUNGSBEZEICHNUNG FROM KUNDE LEFT JOIN BESTELLUNG ON BESTELLUNG.KUNDENNR = KUNDE.KUNDENNR LEFT JOIN BESTELLUNGSAMMLUNG ON BESTELLUNGSAMMLUNG.BESTELLNR = BESTELLUNG.BESTELLNR LEFT JOIN SAMMLUNG ON SAMMLUNG.SAMMLUNGSNR = BESTELLUNGSAMMLUNG.SAMMLUNGSNR WHERE KUNDE.KUNDENNR = :userid";
