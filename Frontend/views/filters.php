<form method="post">
    ...
    <?php foreach($vars['allergies'] as $allergy) { ?>
        <label for="allergy<?php echo  $allergy['ALLERGENNR']; ?>"><?php echo  $allergy['ALLERGENBEZEICHNUNG']; ?></label>
    ...
    <?php }?>
    <h3>Kategorien</h3>
    <label for="categoryall">Alle</label>
    ...
    <?php foreach($vars['nutrition_categories'] as $category) { ?>
        <label for="category<?php echo  $category['KATEGORIENR']; ?>"><?php echo  $category['KATEGORIEBEZEICHNUNG']; ?></label>
